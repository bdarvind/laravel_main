...
@section('title', 'Create Exam - Quiz Admin')
@section('toolbar_title', 'Create Exam')
@section('name', Auth::user()->name )
@section('image', Auth::user()->image)
@section('content')
    <form method="POST" action="{{ route('exam_add') }}">
        @csrf
        <div class="form-group" style="margin: 10px 100px 15px 15px">
            ...
            <input type="text" class="form-control" name="exam_title" id="exam_title", required="true" placeholder="Type the title of exam" >
        </div>
        <div class="form-group" style="margin: 10px 100px 15px 15px">
                    ...
                    <div class="card-body" id="question_id">
                        <div  class="checkbox" >
                            @foreach($questions as $question)
                                <input value="{{$question['id']}}" name="question_id" id="question" type="checkbox" onclick="clickCheckBox(this)">   {{$question['title']}}</br>
                                <hr>
                            @endforeach
                        </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div
                        ...
                        <select id = "number_of_questions">
                            <option id="question_number" >0</option>
                        </select>
                    </div>
